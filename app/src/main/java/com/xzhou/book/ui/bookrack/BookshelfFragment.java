...
import com.xzhou.book.ui.main.MainActivity;
...
public class BookshelfFragment extends BaseFragment<BookshelfContract.Presenter> implements BookshelfContract.View {
    ...
    @Override
    public void onDataChange(List<Entities.Book> books) {
    ...
    @Override
    public void onAdd(Entities.Book book) {
        mAdapter.addData(book);
    }

    @Override
    public void onRemove(Entities.Book book) {
